//! The Microsoft TimeZone ID table, kept in UTC-offset order.
//!
//! Separated from the query helpers in the parent module purely for size;
//! see [`super`] for what these IDs are and how they are used.
